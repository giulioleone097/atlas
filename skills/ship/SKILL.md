...
8. Reconcile the enclosing goal through `<plugin root>/skills/build/references/native.md` using actual delivery evidence; an opened PR does not satisfy a requested merge/deployment. Keep the lesson: `references/learn.md`.
