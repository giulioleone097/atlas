...
| `reverse` | reconstructing how an achieved result can be replicated | Extract transferable causal principles through recursive analysis; expand causal evidence with --drilldown or implementations with --kit |
